...
function keyPressed(){
	if(keyCode === UP_ARROW){
		Matter.Body.applyForce(bobObject1.body,bobObject1.body.position,{x:-1700,y:1700})
	}
	if(keyCode === 50) {
		Matter.Body.applyForce(bobObject1.body,bobObject1.body.position,{x:-1700,y:1700});
		Matter.Body.applyForce(bobObject2.body,bobObject2.body.position,{x:-1700,y:1700});
	}
}
